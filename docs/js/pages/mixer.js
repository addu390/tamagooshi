...
import { loadPack, frameSrc, defaultSelection } from "../mixer/pack.js";
import { createRenderer } from "../mixer/render.js";
import { renderFrame, renderSheet, downloadCanvas, mascotYaml, mascotTree, mascotId } from "../mixer/exporter.js";
...
async function initMixers() {
  const base = "assets/mixer/manifests/";
